...
data segment
    ...
    main1 db "nhom 16"
    main2 db "In this game you must eat 9 letters by sequence:"
    main3 db "eat the win"
    main4 db "Move the snake by pressing the keys w,a,s,d"
    main5 db "w:move up"
    main6 db "s:move down"
    main7 db "d:move right"
    main8 db "a:move left"
    about1 db "This game is done by:nhom 16"
    ...
    point dw  '1'  ; so diem
    poin db 'point: '
    gmwin db "You Win"      ; hien thi win 
    gmov db "Game Over"      ; hien thi thua
    endtxt db "Press esc to exit"   ; thoat game sau khi choi
